...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url("admin/rekapitulasi_production_order/rekapitulasi_production_order"); ?>" style="color: #777;">Rekap.PO</a></li>
            ...
            <div class="col-md-12">
              ...
              <div class="col-xs-12"><br>
                ...
                <table class="body-black">
                  <tr>
                    <th class="text-center body-black" width="45" style="background-color: #ddd"><h5 style="padding-top: 10px;"><b>No</b></h5></th>
                    <th class="text-center body-black" width="250" style="background-color: #ddd"><h5 style="padding-top: 10px;"><b>Arrival Order</b></h5></th>
                    <th class="text-center body-black" width="150" style="background-color: #ddd"><h5 style="padding-top: 10px;"><b>Tanggal</b></h5></th>
                    <th class="text-center body-black" width="250" style="background-color: #ddd"><h5 style="padding-top: 10px;"><b>Style</b></h5></th>
                    <th class="text-center body-black" width="100" style="background-color: #ddd"><h5 style="padding-top: 10px;"><b>Qty</b></h5></th>
                    <th class="text-center body-black" width="380" style="background-color: #ddd"><h5 style="padding-top: 10px;"><b>Keterangan</b></h5></th>
                    <th class="text-center body-black" width="150" style="background-color: #ddd"><h5 style="padding-top: 10px;"><b>Ship Date</b></h5></th>
                  </tr>
