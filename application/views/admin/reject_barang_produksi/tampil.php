  ...
  <section class="content">
    ...
    <h5>
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url("admin/reject_barang_produksi/reject_barang_produksi"); ?>" style="color: #777;">Reject Barang Produksi</a></li>
      </ol>
    </h5>
                ...
                <?php foreach ($reject as $key => $value): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <a href="<?php echo base_url("admin/reject_barang_produksi/reject_barang_produksi/detail/$value[id_reject_barang_produksi]"); ?>" class="btn btn-info btn-sm" title="Detail" data-content="Popover body content is set in this attribute." ><i class="fa fa-info"></i></a>
