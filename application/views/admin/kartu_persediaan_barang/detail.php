...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("admin/laporan/kartu_persediaan_barang"); ?>" style="color: #777;" onclick="return confirm('Anda yakin hendak meninggalkan halaman ini?')">Kartu Persediaan Barang</a></li>
          ...
          <div class="form-group">
            <div class="col-md-12">
              <div>
                ...
                <form method="post">
                  <div class="col-xs-3 hidden-print" style="padding-top: 10px;">
                    <label>Bulan</label>
                  ...
                  <table class="body-black"> 
                    <thead>
                      <tr style="background-color: #ddd;">
                        ...
                        <th class="text-center body-black" width="150"><h5 style="padding-top: 10px;"><b>Tanggal</b></h5></th>
                        <th class="text-center body-black" width="200"><h5 style="padding-top: 10px;"><b>Nomor Bukti</b></h5></th>
                        <th class="text-center body-black" width="325"><h5 style="padding-top: 10px;"><b>Keterangan</b></h5></th>
                        <th class="text-center body-black" width="150"><h5 style="padding-top: 10px;"><b>Qty Masuk</b></h5></th>
                        <th class="text-center body-black" width="150"><h5 style="padding-top: 10px;"><b>Qty Keluar</b></h5></th>
                        <th class="text-center body-black" width="150"><h5 style="padding-top: 10px;"><b>Saldo</b></h5></th>
                      </tr>
                    </thead>
                        ...
                        <tr>
                          ...
                          <td class="text-center body-black" style="font-size: 14px;">
                            <?php if(!empty($value['qty_masuk'])): ?>
                              <?php echo number_format($value['qty_masuk'], 2); ?>
                          ...
                          <td class="text-center body-black" style="font-size: 14px;">
                            <?php if(!empty($value['qty_keluar'])): ?>
                              <?php echo number_format($value['qty_keluar'], 2); ?>
                            <?php elseif(empty($value['qty_keluar'])): ?>
                              <?php echo "-"; ?>
                            <?php endif ?>
                          </td>
                          <td class="text-center body-black" style="font-size: 14px;"><?php echo number_format($value['saldo'], 2, ",", "."); ?></td>
                        </tr>
                      <?php endforeach ?>
                    </tbody>
                  </table><br>
