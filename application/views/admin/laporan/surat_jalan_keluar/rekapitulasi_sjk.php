...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("admin/laporan/surat_jalan_keluar/rekapitulasi_sjk"); ?>" style="color: #777;">Rekapitulasi Laporan Surat Jalan Keluar</a></li>
    </ol>
  </h5>
