...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("admin/laporan/lpb"); ?>" style="color: #777;" onclick="return confirm('Anda yakin hendak meninggalkan halaman ini?')">LPB</a></li>
                  ...
                  <tr>
                    ...
                    <td>&nbsp;
                      ...
                      <?php elseif (empty($ambil_lpb['no_purchase_order'])): ?>
                        <?php echo "<button class='btn btn-default'>Mohon Menunggu</button>"; ?>
                      <?php endif ?>
                    </td>
                  </tr>
                </table>
              ...
              <div class="col-xs-12" style="padding-left: 50px;">
                <table>
                  <tr>
                    ...
                    <td>:</td>
                    <td style="padding-left: 5px;padding-bottom: 9px;">&nbsp;<?php echo $ambil_lpb['keterangan']; ?></td>
                  </tr>
                </table>
              </div>
