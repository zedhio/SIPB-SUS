                    ...
                    <?php if ($value['distribusi'][0]['tujuan']=="Administrasi Gudang"): ?>
                      <tr>
                        ...
                        <td class="text-center">
                          <!-- detail -->
                          <a href="<?php echo base_url("admin/laporan/production_order/detail/$value[id_po]"); ?>" class="btn btn-info btn-sm" title="Unduh File (PDF)" data-content="Popover body content is set in this attribute."><i class="fa fa-info"></i></a>

                          <a href="<?php echo base_url("admin/laporan/production_order/preview_lap_po/$value[id_po]"); ?>" class="btn btn-primary btn-sm" title="Unduh File (PDF)" data-content="Popover body content is set in this attribute."><i class="fa fa-file-pdf-o"></i></a>
