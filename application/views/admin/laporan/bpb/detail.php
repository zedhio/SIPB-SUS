...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("admin/laporan/bpb"); ?>" style="color: #777;" onclick="return confirm('Anda yakin hendak meninggalkan halaman ini?')">BPB</a></li>
            ...
            <div class="col-md-12">
              ...
              <div class="col-xs-12" style="padding-left: 450px;">
                <table>
                  <tr>
                    ...
                    <td>:</td>
                    <td style="font-size: 14px;">&nbsp; <?php echo $ambil_bpb['no_bpb']; ?></td>
                  </tr>
                </table>
              </div>
              <div class="col-xs-12" style="padding-left: 450px;">
                <table>
                  <tr>
                    ...
                    <td>:</td>
                    <td style="font-size: 14px;">&nbsp; <?php echo $ambil_bpb['tgl_dibuat']; ?></td>
                  </tr>
                </table>
              </div>
              <div class="col-xs-12" style="padding-left: 450px;">
                <table>
                  <tr>
                    ...
                    <td>:</td>
                    <td style="font-size: 14px;">&nbsp; <?php echo $ambil_bpb['bagian']; ?></td>
                  </tr>
                </table>
              </div>
              <div class="col-xs-12" style="padding-top: 40px;padding-left: 160px;">
                <table>
                  <tr>
                    <th width="25">P.O</th>
                    <td>:</td>
                    ...
                    <th width="45" style="padding-left: 20px;">Order</th>
                    <td>:</td>
                    <td>&nbsp; <?php echo $ambil_bpb['qty']; ?></td>
                    
                    <th width="45" style="padding-left: 20px;">Buyer</th>
                    <td>:</td>
                    <td>&nbsp; <?php echo $ambil_bpb['nama_buyer']; ?></td>

                    <th width="100" style="padding-left: 20px;">Style Glove</th>
                    <td>:</td>
              ...
              <div class="col-xs-12"><br>
                <table class="body-black">
                  ...
                  <tr style="background-color: #ddd;">
                    <td class="text-center body-black" width="300" height="30" style="font-size: 14px;"><b>Qty Barang</b></td>
                    <td class="text-center body-black" width="100" style="font-size: 14px;"><b>Satuan</b></td>
                    <td class="text-center body-black" width="100" style="font-size: 14px;"><b>Ukuran</b></td>
                  </tr>
                  <!-- / Header -->
