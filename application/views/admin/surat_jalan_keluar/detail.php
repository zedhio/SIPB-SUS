...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("admin/surat_jalan_keluar/surat_jalan_keluar"); ?>" style="color: #777;" onclick="return confirm('Anda yakin hendak meninggalkan halaman ini?')">Surat Jalan Keluar</a></li>
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="border: 0px; background-color: transparent;">:</td>
                        <td style="text-align: left; border: 0px; background-color: transparent;"><?php echo date('d-m-Y', strtotime($ambil_sjk['tgl_dibuat'])); ?></td>
                      </tr>
                    </tbody>
                  </table>    
                </div>
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="border: 0px; background-color: transparent;">:</td>
                        <td style="border: 0px; background-color: transparent;"><?php echo $detail['tindakan']; ?></td>
                      </tr>
                    </tbody>
                  </table>    
                </div>
