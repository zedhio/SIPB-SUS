...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("admin/bpb/bpb"); ?>" style="color: #777;" onclick="return confirm('Anda yakin hendak meninggalkan halaman ini?')">Bukti Pengeluaran Barang</a></li>
              ...
              <div class="col-xs-12"><br>
                <table class="body-black">
                  ...
                  <tr style="background-color: #ddd;">
                    <th rowspan="2" class="text-center body-black" height="30" width="30"><h5 style="padding-top: 10px;"><b>No</b></h5></th>
