...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("user/surat_jalan_masuk/surat_jalan_masuk"); ?>" style="color: #777;" onclick="return confirm('Anda yakin hendak meninggalkan halaman ini?')">Surat Jalan Masuk</a></li>
    ...
    <div class="col-xs-10">
      ...
      <div class="box body-blue">
        ...
        <div class="box-body" style="padding-top: 25px;">
          ...
          <div class="col-md-8" style="position: absolute; padding-top: 190px; padding-left: 329px;">
            <div class="form-group">
              <div class="text-left">
                <div class="form-group">
                  <table class="table">
                    <tbody>
                      <tr>
                        ...
                        <td style="border: 0px; background-color: transparent;">:</td>
                        <td style="border: 0px; background-color: transparent;"><?php echo strip_tags($ambil_sjm['keterangan']); ?></td>
                      </tr>   
                    </tbody>
                  </table>    
                </div>
              ...
              <table style="margin-left: 28px; margin-right: 28px;">
                ...
                <?php foreach ($ambil_kalkulasi as $key => $value): ?>
                  <tr>
                    ...
                    <td class="text-center body-black" style="font-size: 14px;"><?php echo number_format($value['qty_sjm'], 2); ?></td>
                ...
                <tr>
                  ...
                  <td colspan="3" class="text-center body-black" style="font-size: 14px;"><?php echo number_format($ambil_total['qty_total'], 2); ?></td>
                </tr>
                <!-- Record -->
              </table>
