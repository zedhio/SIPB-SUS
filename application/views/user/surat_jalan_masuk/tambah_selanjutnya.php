...
<section class="content">
  ...
  <h5>
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("user/surat_jalan_masuk/surat_jalan_masuk/tambah"); ?>" style="color: #777;" onclick="return confirm('Anda punya perubahan yang belum disimpan; Anda yakin hendak meninggalkan halaman ini?')">Tambah</a></li>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="box-body">
                    ...
                    <div class="col-xs-1">
                      <label>Qty</label>
                      <input type="number" class="form-control" name="qty_sjm" placeholder="0">
                    </div>
                    <div class="col-xs-1">
                      <label>Satuan</label>
                  ...
                  <div class="box-body">
                    <div class="col-xs-3">
                      ...
                      <?php elseif (!empty($tbl_sjm)): ?>
                        <button class="btn btn-default fa fa-arrow-down" name="tambah" value="tambah" id="tambah" title="Tambah Record" data-content="Popover body content is set in this attribute." disabled="disabled"> Tambahkan</button>
                      <?php endif ?>
                    </div>  
                  </div>
                </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                <div class="row">
                  <div class="box-body">
                    <div class="col-xs-6">
                      <!-- <button class="btn btn-primary fa fa-arrow-left" name="simpan_temp1" value="simpan_temp1" title="Halaman Sebelumnya" data-content="Popover body content is set in this attribute."> Sebelumnya</button>
                      &nbsp; -->
