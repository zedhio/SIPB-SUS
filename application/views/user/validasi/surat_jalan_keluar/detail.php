...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("user/validasi/surat_jalan_keluar"); ?>" style="color: #777;" onclick="return confirm('Anda yakin hendak meninggalkan halaman ini?')">Data Surat Jalan Keluar</a></li>
    ...
    <div class="col-xs-10">
      ...
      <div class="box body-blue">
        <div class="box-header with-border">
          ...
          <h3 class="text-center"><u><b>Surat Jalan Keluar</b></u></h3>
          <br>
        </div>
        <!-- /.box-header -->
        ...
        <div class="box-body" style="padding-top: 25px;">
              ...
              <div class="text-left">
                <div class="form-group">
                  <table class="table">
                    <tbody>
                      <tr>
                        <th width="173" style="border: 0px; background-color: transparent;">No.Surat Jalan Keluar</th>
                        <td style="border: 0px; background-color: transparent;">:</td>
                        <td style="text-align: left; border: 0px; background-color: transparent;"><?php echo $ambil_sjk['no_sjk']; ?></td>
                      </tr>
                      <tr>
                        <th style="border: 0px; background-color: transparent;">No.Pemeriksaan Barang</th>
                        <td style="border: 0px; background-color: transparent;">:</td>
                        <td style="text-align: left; border: 0px; background-color: transparent;"><?php echo $ambil_sjk['no_pemeriksaan_barang']; ?></td>
                      </tr>
                      <tr>
                        <th style="border: 0px; background-color: transparent;">Keterangan</th>
                        <td style="border: 0px; background-color: transparent;">:</td>
                        <td style="text-align: left; border: 0px; background-color: transparent;"><?php echo $detail['tindakan']; ?></td>
                      </tr>
                    </tbody>
                  </table>    
                </div>
              ...
              <div class="text-left">
                <div class="form-group">
                  <table class="table">
                    <tbody>
                      <tr>
                        <th style="border: 0px; background-color: transparent;" width="125">Ditujukan</th>
                        <td style="border: 0px; background-color: transparent;">:</td>
                        <td style="text-align: left; border: 0px; background-color: transparent;"><?php echo $detail['nama_supplier']; ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <th style="border: 0px; background-color: transparent;">Tgl.Dibuat Surat</th>
                        <td style="border: 0px; background-color: transparent;">:</td>
                        <td style="text-align: left; border: 0px; background-color: transparent;"><?php echo $ambil_sjk['tgl_dibuat']; ?></td>
                      </tr>   
                    </tbody>
                  </table>    
                </div>
          ...
          <div class="form-group">
            <div class="col-md-12">
              <table class="body-black" style="margin-left: 28px; margin-right: 28px;">
                <!-- Header -->
                <tr style="background-color: #ddd;">
                  <!-- <th rowspan="2" class="text-center body-black" height="30" width="40"><h5 style="padding-top: 10px;"><b>No</b></h5></th> -->
                ...
                <?php endforeach ?>
                <!-- <tr> -->
                  <!-- <td colspan="4" height="30" class="text-center body-black" style="font-size: 14px;"><b>Qty Total</b></td> -->
