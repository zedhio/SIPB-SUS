...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("user/validasi/bpb"); ?>" style="color: #777;" onclick="return confirm('Anda yakin hendak meninggalkan halaman ini?')">Bukti Pengeluaran Barang</a></li>
          ...
          <div class="form-group">
            <div class="col-md-12">
              <div>
                ...
                <h3 class="text-center"><u><b>BUKTI PENGELUARAN BARANG</b></u></h3>
                <hr>
              </div>
              <br><br>
              ...
              <div class="col-xs-12" style="padding-left: 450px;">
                <table>
                  <tr>
                    ...
                    <td>:</td>
                    <td style="font-size: 15px;">&nbsp; <?php echo $ambil_bpb['tgl_dibuat']; ?></td>
                  </tr>
                </table>
              </div>
              <div class="col-xs-12" style="padding-left: 450px;">
              ...
              <div class="col-xs-4" style="padding-top: 40px; padding-left: 35px;">
                <table>
                  <tr>
                    <th width="30">P.O</th>
                    <td>:</td>
              ...
              <div class="col-xs-2" style="padding-top: 40px; padding-left: 70px;">
                <table>
                  <tr>
              ...
              <div class="col-xs-3" style="padding-top: 40px; padding-left: 70px;">
                <table>
                  <tr>
              ...
              <div class="col-xs-3" style="padding-top: 40px; padding-left: 45px;">
                <table>
                  <tr>
              ...
              <?php if (!empty($ambil_bpb['validasi'][0]['alasan'])): ?>
                <div class="col-xs-12"><br><br>
                  <table align="center">
                    <tr>
                      <td style="color: red;"><span class="fa fa-warning"></span> Kepala Unit Sewing memberikan hasil penolakan dengan alasan <?php echo $ambil_bpb['validasi'][0]['alasan']; ?></td>
                    </tr>
                  </table><br>
                </div>
              <?php elseif (!empty($ambil_bpb['validasi'][1]['alasan'])): ?>
                <div class="col-xs-12"><br><br>
                  <table align="center">
                    <tr>
                      <td style="color: red;"><span class="fa fa-warning"></span> Kepala Gudang memberikan hasil penolakan dengan alasan <?php echo $ambil_bpb['validasi'][1]['alasan']; ?></td>
                    </tr>
                  </table><br>
                </div>
              <?php elseif (!empty($ambil_bpb['validasi'][2]['alasan'])): ?>
                <div class="col-xs-12"><br><br>
                  <table align="center">
                    <tr>
                      <td style="color: red;"><span class="fa fa-warning"></span> Kepala Divisi Production Manager memberikan hasil penolakan dengan alasan <?php echo $ambil_bpb['validasi'][2]['alasan']; ?></td>
                    </tr>
                  </table><br>
                </div>
              <?php endif ?>
              ...
              <div class="col-xs-12"><br>
                <table class="body-black">
                  ...
                  <tr style="background-color: #ddd">
                    <td class="text-center body-black" height="30" width="150" style="font-size: 14px;"><b>Warna</b></td>
                  ...
                  <?php foreach ($ambil_kalkulasi as $key => $value): ?>
                    <tr>
                      ...
                      <td class="text-center body-black" style="font-size: 14px;"><?php echo $value['qty_bpb']; ?></td>
