...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("user/validasi/production_order"); ?>" style="color: #777;" onclick="return confirm('Anda yakin hendak meninggalkan halaman ini?')">Production Order</a></li>
        ...
        <div class="box-body" style="padding-top: 25px;">
          ...
          <div class="form-group">
            <div class="col-md-12">
              ...
              <?php if (!empty($production_order[0]['validasi_po'][0]['alasan'])): ?>
                <div class="col-xs-12"><br><br>
                  <table align="center">
                    <tr>
                      <td style="color: red;"><span class="fa fa-warning"></span> Kepala Gudang memberikan hasil penolakan dengan alasan <?php echo $production_order[0]['validasi_po'][0]['alasan']; ?></td>
                    </tr>
                  </table><br>
                </div>
              <?php elseif (!empty($production_order[0]['validasi_po'][1]['alasan'])): ?>
                <div class="col-xs-12"><br><br>
                  <table align="center">
                    <tr>
                      <td style="color: red;"><span class="fa fa-warning"></span> Kepala Divisi Production Manager memberikan hasil penolakan dengan alasan <?php echo $production_order[0]['validasi_po'][1]['alasan']; ?></td>
                    </tr>
                  </table><br>
                </div>
              <?php elseif (!empty($production_order[0]['validasi_po'][2]['alasan'])): ?>
                <div class="col-xs-12"><br><br>
                  <table align="center">
                    <tr>
                      <td style="color: red;"><span class="fa fa-warning"></span> Direktur memberikan hasil penolakan dengan alasan <?php echo $production_order[0]['validasi_po'][2]['alasan']; ?></td>
                    </tr>
                  </table><br>
                </div>
              <?php endif ?>
              ...
              <div class="col-xs-3"><br>
                <table>
                  <!-- Header -->
                  <tr align="center">
                    <th colspan="4" class="text-center body-black" width="500"><h5 style="padding-top: 10px;"><b>Ladies Cadet</b></h5></th>
                  </tr>
                  <tr>
                    <td class="text-center body-black" width="50" height="30" style="font-size: 14px;"><b>No</b></td>
                    <td class="text-center body-black" width="80" style="font-size: 14px;"><b>Hands</b></td>
                ...
                <table>
                  ...
                  <tr>
                    <td class="text-center body-black" width="204" height="30" style="font-size: 14px;">Sub Total</td>
              ...
              <div class="col-xs-3"><br>
                <table>
                  <!-- Header -->
                  <tr>
                    <td class="text-center body-black" height="30" width="500" style="font-size: 14px;"><b>Remark</b></td>
                  </tr>
                  <!-- / Header -->
