...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("user/data_master/buyer/buyer"); ?>" style="color: #777;" onclick="return confirm('Anda yakin hendak meninggalkan halaman ini?')">Buyer</a></li>
                ...
                <div class="form-group">
                  <center>
                    ...
                    <?php elseif (empty($buyer['logo_buyer'])): ?>
                      <img src="<?php echo base_url("assets/images/logo_buyer/no-image.png"); ?>" style="width:200px; height: 150px;" class="profile-user-img img-thumbnail">
                    <?php endif ?>
                  </center>
                </div>
              </div>
