              ...
              <div class="col-xs-12"><br>
                <table class="body-black" style="margin-left: 30px; margin-right: 30px;">
                  ...
                  <tr style="background-color: #ddd">
                    <!-- <th class="text-center body-black" width="40" height="30"><h5 style="padding-top: 10px;"><b>No</b></h5></th> -->
                    <th class="text-center body-black" width="250" height="30"><h5 style="padding-top: 10px;"><b>Nama Barang</b></h5></th>
                    ...
                    <th class="text-center body-black" width="310"><h5 style="padding-top: 10px;"><b>Alasan Reject</b></h5></th>
                  </tr>
                  <!-- / Header -->
                  ...
                  <!-- Record -->
                  <tr>
                    <td class="text-center body-black" style="font-size: 14px;" height="30"><?php echo $ambil_reject['nama_barang']; ?></td>
