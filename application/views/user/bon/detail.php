              ...
              <div class="col-xs-12"><br>
                <table class="body-black">
                  ...
                  <tr style="background-color: #ddd;">
                    ...
                    <th rowspan="2" class="text-center body-black" width="180"><h5 style="padding-top: 10px;"><b>Jenis</b></h5></th>
                    <th rowspan="2" class="text-center body-black" width="180"><h5 style="padding-top: 10px;"><b>Sub Jenis</b></h5></th>
                    <th colspan="3" class="text-center body-black" height="30" style="font-size: 14px;;"><b>Jumlah</b></th>
                  </tr>
                  <tr style="background-color: #ddd;">
                    <td class="text-center body-black" width="100" height="30" style="font-size: 14px;"><b>Qty Bon</b></td>
                    <td class="text-center body-black" width="100" style="font-size: 14px;"><b>Satuan</b></td>
                    <td class="text-center body-black" width="300" style="font-size: 14px;"><b>Remaks</b></td>
                  </tr>
                  <!-- / Header -->
