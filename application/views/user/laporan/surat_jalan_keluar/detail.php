...
<section class="content">
  ...
  <h5 class="hidden-print">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url("user/laporan/surat_jalan_keluar"); ?>" style="color: #777;" onclick="return confirm('Anda yakin hendak meninggalkan halaman ini?')">Laporan Surat Jalan Keluar</a></li>
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="border: 0; background-color: transparent;">:</td>
                        <td style="border: 0; background-color: transparent; text-align: left;"><?php echo $detail['tindakan']; ?></td>
                      </tr>
                    </tbody>
                  </table>    
                </div>
            ...
            <div class="col-md-12">
              <table class="body-black" style="margin-left: 30px; margin-right: 30px;">
                ...
                <?php foreach ($ambil_kalkulasi as $key => $value): ?>
                  <tr>
                    <td class="text-center body-black" style="font-size: 14px;" height="30"><?php echo $value['nama_barang']; ?></td>
